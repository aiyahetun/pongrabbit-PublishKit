...
| 文档版本 | 1.1 |
| 创建日期 | 2026-08-24 |
| 最后整理 | 2026-08-24（M1 v0.1.0 本地验收后） |
...
| BUG-2026-08-24-04 | 桌面端 | 来源文件 / 拆分向导仍含 scoped `button {}`，主按钮可能再现空白 | 未修 | 2026-08-24 |
...
| 解决方案 | 待办：移除 scoped `button {}`，统一引用 `tokens.css` 的 `pk-btn` |
